<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Clergy Expiring report
      </h1>
    </section>
    <section class="content">
        ...
        <style>
           ...
           #invoicetable th {
            ...
            <meta charset=utf-8 />
            <title>Clergy Expiring report</title>
          </head>
          <body>
            <div class="box box-info">
              ...
              <table id="invoicetable">
                <thead>
                  <tr>
                     ...
                     <th style="text-align:center;">Ordination Date</th>
                     <th style="text-align:center;">Photo Download</th>
                     <th style="text-align:center;display:none;">Father Name</th>
                 </tr>
                </thead>
                <tbody>
                  <?php
              ...
              $result = $db->prepare("SELECT * from add_clergy_details");
              $result->execute();
              ...
              ?>
              <tr>
              <td style="text-align:center;"><?php echo $row['clergy_id']; ?></td>
              <td style="text-align:center;"><?php echo $row['name']; ?></td>
              <td><img class="img-thumbnail " src="https://eridiocese.parishtome.com/gallery/clergyform/<?php echo $row['photo']; ?>" width="75px" height="75px" border="1" /></td>
              <td style="text-align:center;"><?php echo $row['gender']; ?></td>
             <td style="text-align:center;"><?php echo $row['blood_group']; ?></td>
              <td style="text-align:center;"><?php echo $row['caste']; ?></td>
              <td style="text-align:center;"><?php echo $row['religion']; ?></td>
              <td style="text-align:center;"><?php echo $row['ordi_date']; ?></td>
              <td style="text-align:center;"><a href="https://eridiocese.parishtome.com/gallery/clergyform/<?php echo $row['photo']; ?>" download="<?php echo $row['photo']; ?>"><button class="btn btn-success">Photo Download</button></a></td>
              <td style="text-align:center;display:none;"><?php echo $row['father_name']; ?></td>
