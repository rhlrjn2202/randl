<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Add, Manage Categories</small>
      </h1>
    </section>
...
$categories = mysqli_real_escape_string($db, $_POST["categories"]);
 ...
 $sql = "INSERT INTO manage_categories (categories) VALUES ('".$categories."')";
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-4">
								   ...
								   <input type="text" name="categories" placeholder="Add Categories" class="form-control">
								   </div>
