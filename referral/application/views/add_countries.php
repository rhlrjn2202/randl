<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>Manage Manufacturers
        <small>Add, Manage Manufacturers</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Manage Manufacturers</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
...
$manu_url = mysqli_real_escape_string($db, $_POST["manu_url"]);
$countries_name = mysqli_real_escape_string($db, $_POST["countries_name"]);

 
 $sql = "INSERT INTO manage_manufacturers (manufacturers,manu_url,countries_name) VALUES ('".$manufacturers."','".php_slug($manu_url)."','".$countries_name."')";

 if(mysqli_query($db, $sql))
 {
 session_start();
    $_SESSION['success_message'] = "Country saved successfully.";
} else {
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-4">
								   ...
								   <label>Manufacture site Url:</label>
								   <input type="text" name="manu_url" class="form-control">
								   </div>  
								 <div class="form-group col-md-4"> 
                                  <label>Choose Countries:</label>
								   <select name="countries_name" class="form-control">
									<?php
