<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>Manage Contact Us
        <small>Add, Manage Contact Us</small>
      </h1>
    </section>
...
$sql = "UPDATE manage_contactus SET title = '$title',content = '$content' WHERE about_id = 1";


 if(mysqli_query($connect, $sql))
 {
  redirect('Add_aboutus');
 }
}
...
$query = "SELECT * FROM manage_contactus";
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-4">
								   <label>Title:</label>
								   <input type="text" name="title" placeholder="Add Title" value="<?php echo $title ?>" class="form-control">
								   </div>
