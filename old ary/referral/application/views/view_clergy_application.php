<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Add/Edit Clergy Details
        <small>Edit</small>
      </h1>
    </section>
  <?php
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>Add_clergy_application"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    ?>
                    <tr>
                      <td><?php echo $record->clergy_appli_id ?></td>
                      <td><?php echo $record->control_no ?></td>
                       ...
                       <td>
                 <button class="btn btn-success user_status" uid="<?php echo $record->clergy_appli_id; ?>"  ustatus="2"><i class="fa fa-check" aria-hidden="true"></i>
      </button>
           <button class="btn btn-danger user_status" uid="<?php echo $record->clergy_appli_id; ?>"  ustatus="3"><i class="fa fa-times" aria-hidden="true"></i>
      </button>
                  </td>
                      <td>
...
Disapprove</button>
      ...
      <td class="text-center">
        <a class="btn btn-sm btn-info" href="<?php echo base_url().'editclergy_application/'.$record->clergy_appli_id; ?>" target="_blank"><i class="fa fa-pencil"></i></a>
        <a class="btn btn-sm btn-danger deleteUser" href="#" data-userid="<?php echo base_url().'deletedata/'.$record->clergy_appli_id; ?>"><i class="fa fa-trash"></i></a>
      </td>
                    </tr>
                    <?php
                        }
...
<div class="modal modal-danger fade" id="modal_popup">
  <div class="modal-dialog modal-sm">
    <form action="<?php echo base_url(); ?>clergy_user_status_changed" method="post">
       <div class="modal-content">
        ...
        <input type="hidden" name="clergy_appli_id" id="user_id" value="">
  ...
  <script type="text/javascript">
      jQuery(document).ready(function(){
          jQuery('ul.pagination li a').click(function (e) {
              ...
              jQuery("#searchList").attr("action", baseURL + "view_clergy_application/" + value);
