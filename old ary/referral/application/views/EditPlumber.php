...
if(!empty($PlumberInfo))
{
    foreach ($PlumberInfo as $uf)
    {
        $userId = $uf->plumber_id;
		$sl = $uf->sl;
        $name = $uf->name;
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>EditPlumberUser" enctype="multipart/form-data" method="post" id="editUser" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                       <label for="sl">Sl No</label>
                                        ...
                                        <input type="hidden" value="<?php echo $userId; ?>" name="plumber_id" id="plumber_id" />    
                                    </div>
