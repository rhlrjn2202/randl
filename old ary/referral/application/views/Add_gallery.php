<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Add Gallery Image
...
if(isset($_POST["submit_btn"]))
{
 ...
 $target = "gallery/".basename($gallery_image);
 
 $sql = "INSERT INTO carousel_gallery (gallery_image) VALUES ('".$gallery_image."')";
 	mysqli_query($db, $sql);
 ...
 // $msg = "Image uploaded successfully";
  ...
  $result = mysqli_query($db, "SELECT * FROM carousel_gallery");
