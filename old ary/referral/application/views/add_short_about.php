<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>Manage Short About
        <small>Add, Manage Short About</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Manage Short About</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
   <?php
...
$sql = "UPDATE short_about SET about = '$about' WHERE about_id = 1";


 if(mysqli_query($connect, $sql))
 {
  redirect('add_short_about');
 }
}
                    ...
                    <form role="form" id="addUser" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form">
                        <div class="box-body">
                            <div class="row">
								   ...
								   <label>Content:</label>
								  <textarea name="about" id="rich-editor" class="form-control"><?php echo $about; ?></textarea>
