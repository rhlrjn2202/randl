<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>Add Bill Application
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Bill Application</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    $amount = $_POST["amount"];
                    $amount_inwords = $_POST["amount_inwords"];
                    $status = $_POST["status"];
                                      
                     $sql = mysqli_query($con,"INSERT INTO bill_application (name,date,receipt_no,amount,amount_inwords,status)
                      VALUES ('".$name."','".$date."','".$receipt_no."','".$amount."','".$amount_inwords."','".$status."')");
                          // }
                          if($sql==true)
                           {
                    ...
                    <form role="form" id="addUser" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form">
                        <div class="box-body">
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                      <label for="reviews">Receipt Date</label>
                                      <input type="date" class="form-control required" id="date" name="date">
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="form-group">
                                      <label for="reviews">Receipt NO</label>
                                      <input type="text" class="form-control required" id="receipt_no" name="receipt_no" >
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="form-group">
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                      <label for="reviews">Amount IN Words</label>
                                      <input type="text" class="form-control required" id="amount_inwords" name="amount_inwords" >
                                  </div>
                              </div>
