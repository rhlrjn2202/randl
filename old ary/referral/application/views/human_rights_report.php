<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Human Rights Expiring report
      </h1>
    </section>
    <section class="content">
        ...
        <style>
           ...
           #invoicetable th {
            ...
            <meta charset=utf-8 />
            <title>Human Rights Expiring report</title>
          </head>
          <body>
            <div class="box box-info">
              ...
              <table id="invoicetable">
                <thead>
                  <tr>
                     ...
                     <th style="text-align:center;">ID Valid Date</th>
                 </tr>
                </thead>
                <tbody>
                  <?php
             ...
             <td style="text-align:center;"><?php echo $row['blood_group']; ?></td>
              ...
              <td style="text-align:center;"><?php echo $row['id_valid_upto']; ?></td>
