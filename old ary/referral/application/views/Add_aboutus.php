<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>Manage About Us
        <small>Add, Manage About Us</small>
      </h1>
    </section>
...
$sql = "UPDATE manage_aboutus SET title = '$title',content = '$content' WHERE about_id = 1";
...
$query = "SELECT * FROM manage_aboutus";
