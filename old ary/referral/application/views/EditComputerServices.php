...
if(!empty($ComputerServicesInfo))
{
    foreach ($ComputerServicesInfo as $uf)
    {
        $userId = $uf->ComputerServices_id;
		$sl = $uf->sl;
        $name = $uf->name;
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter ComputerServices Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" action="<?php echo base_url() ?>EditComputerServicesUser" enctype="multipart/form-data" method="post" id="editUser" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                       <label for="sl">Sl No</label>
                                        ...
                                        <input type="hidden" value="<?php echo $userId; ?>" name="ComputerServices_id" id="ComputerServices_id" />    
                                    </div>
