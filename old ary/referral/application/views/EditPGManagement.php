...
if(!empty($PGManagementInfo))
{
    foreach ($PGManagementInfo as $uf)
    {
        $userId = $uf->PGmanagement_id;
		$sl = $uf->sl;
        $name = $uf->name;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Add / Edit PGmanagement</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter PGmanagement Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" action="<?php echo base_url() ?>EditPGManagementUser" enctype="multipart/form-data" method="post" id="editUser" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                       <label for="sl">Sl No</label>
                                        ...
                                        <input type="hidden" value="<?php echo $userId; ?>" name="PGmanagement_id" id="PGmanagement_id" />    
                                    </div>
