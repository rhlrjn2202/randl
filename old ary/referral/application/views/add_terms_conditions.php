<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>Manage Terms and conditions
        <small>Add, Manage Terms and conditions</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Manage Terms and conditions</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
   <?php
...
if(isset($_POST["submit_btn"]))
{
 ...
 //htmlentities() - htmlentities() function converts special characters to HTML entities.
  ...
  $terms_content = mysqli_real_escape_string($connect, $_POST["terms_content"]); 
 $terms_content = htmlentities($terms_content);

$sql = "UPDATE terms_condition SET terms_content = '$terms_content' WHERE terms_id = 1";


 if(mysqli_query($connect, $sql))
 {
  redirect('add_terms_conditions');
 }
}
...
$terms_content = html_entity_decode($terms_content);
?>
                    ...
                    <form role="form" id="addUser" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form">
                        <div class="box-body">
                            <div class="row">
								   ...
								   <label>Content:</label>
								  <textarea name="terms_content" id="rich-editor" class="form-control"><?php echo $terms_content; ?></textarea>
